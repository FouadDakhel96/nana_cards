...
class Finalstep extends Component {
    ...
    submitProducts = () => {
        // TODO: send api to sync_store_products_by_key()
        // this.state
        // update correct_prices in doctype found_in_products_not_in_sotre_proudcts with reviewed = true
    }
                    ...
                    this.state.loading
                        ...
                        <React.Fragment>
                            <div style={{
                                ...
                                <h3 style={{textAlign: 'right'}}>{this.state.correct_prices.length  + this.state.ignore_prices.length}</h3>
